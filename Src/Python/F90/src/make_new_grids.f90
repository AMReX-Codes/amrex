module make_new_grids_module
  ...
  contains
    ...
    subroutine make_new_grids(new_grid_flag,la_crse,la_fine,mf,dx_crse,buf_wid,ref_ratio, &
                              lev,max_grid_size,tag_boxes_cb)
       ...
       call make_boxes(mf,ba_new,dx_crse,buf_wid,tag_boxes_cb,lev,ref_ratio)
    ...
    subroutine make_boxes(mf,ba_new,dx_crse,buf_wid,tag_boxes_cb,lev,ref_ratio)
