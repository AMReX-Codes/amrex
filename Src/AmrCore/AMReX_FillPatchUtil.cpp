...
namespace amrex
{
	...
	Box crse_box(IntVect(BL_D_DECL(0 ,0 ,0 )), IntVect(BL_D_DECL(4*nbuf-1,4*nbuf-1,4*nbuf-1)));
	crse_box.convert(boxType);
	Box fine_box(IntVect(BL_D_DECL(  nbuf  ,  nbuf  ,  nbuf)),
		     IntVect(BL_D_DECL(3*nbuf-1,3*nbuf-1,3*nbuf-1)));
