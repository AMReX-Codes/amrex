...
extern int NHops(const Box &tbox, const IntVect &ivfrom, const IntVect &ivto);
extern void Write2DFab(const string &filenameprefix, const int xdim, const int ydim,
                const double *data);
extern void Write2DText(const string &filenameprefix, const int xdim, const int ydim,
                 const double *data);
extern void Write3DFab(const string &filenameprefix, const int xdim, const int ydim,
