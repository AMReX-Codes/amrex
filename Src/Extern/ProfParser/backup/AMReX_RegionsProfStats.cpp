...
extern void MakeFuncPctTimesMF(const Array<Array<BLProfStats::FuncStat> > &funcStats,
                               const Array<std::string> &blpFNames,
			       const std::map<std::string, BLProfiler::ProfStats> &mProfStats,
			       Real runTime, int dataNProcs);
extern void CollectMProfStats(std::map<std::string, BLProfiler::ProfStats> &mProfStats,
                              const Array<Array<BLProfStats::FuncStat> > &funcStats,
                              const Array<std::string> &fNames,
                              Real runTime, int whichProc);
extern void GraphTopPct(const std::map<std::string, BLProfiler::ProfStats> &mProfStats,
                        const Array<Array<BLProfStats::FuncStat> > &funcStats,
                        const Array<std::string> &fNames,
