...
void
AmrCore::MakeNewGrids (int lbase, int& new_finest, Array<BoxArray>& new_grids) const
{
...
//xxxxx
        ...
        //
//xxxxx        amr_level[levc].manual_tags_placement(tags, bf_lev);
        //
	...
	tags.collate(tagvec);
        ...
        if (tagvec.size() > 0)
        {
            ...
            //
//xxxxx            if ( !(useFixedCoarseGrids && levc<useFixedUpToLevel) )
//xxxxx                new_finest = std::max(new_finest,levf);
            //
