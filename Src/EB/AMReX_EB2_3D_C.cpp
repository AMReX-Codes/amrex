...
void build_cells (Box const& bx, Array4<EBCellFlag> const& cell,
                  ...
                  Real small_volfrac, const Box& domain)
{
    const Box& bxg1 = amrex::grow(bx,1);
    AMREX_HOST_DEVICE_FOR_3D ( bxg1, i, j, k,
    {
        if (cell(i,j,k).isRegular()) {
            ...
            if (i==domain.loVect()[0]-1 and cell(domain.loVect()[0],j,k).isCovered()){
                vfrac(i,j,k) = 0.0;
                vcent(i,j,k,0) = 0.0;
                vcent(i,j,k,1) = 0.0;
                vcent(i,j,k,2) = 0.0;
            ...
            if (i==domain.hiVect()[0]+1 and cell(domain.hiVect()[0],j,k).isCovered()){
                vfrac(i,j,k) = 0.0;
                vcent(i,j,k,0) = 0.0;
                vcent(i,j,k,1) = 0.0;
                vcent(i,j,k,2) = 0.0;
            ...
            if (j==domain.loVect()[1]-1 and cell(i,domain.loVect()[1],k).isCovered()){
                vfrac(i,j,k) = 0.0;
                vcent(i,j,k,0) = 0.0;
                vcent(i,j,k,1) = 0.0;
                vcent(i,j,k,2) = 0.0;
            ...
            if (j==domain.hiVect()[1]+1 and cell(i,domain.hiVect()[1],k).isCovered()){
                vfrac(i,j,k) = 0.0;
                vcent(i,j,k,0) = 0.0;
                vcent(i,j,k,1) = 0.0;
                vcent(i,j,k,2) = 0.0;
            ...
            if (k==domain.loVect()[2]-1 and cell(i,j,domain.loVect()[2]).isCovered()){
                vfrac(i,j,k) = 0.0;
                vcent(i,j,k,0) = 0.0;
                vcent(i,j,k,1) = 0.0;
                vcent(i,j,k,2) = 0.0;
            ...
            if (k==domain.hiVect()[2]+1 and cell(i,j,domain.hiVect()[2]).isCovered()){
                vfrac(i,j,k) = 0.0;
                vcent(i,j,k,0) = 0.0;
                vcent(i,j,k,1) = 0.0;
                vcent(i,j,k,2) = 0.0;
