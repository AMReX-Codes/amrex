...
{
    return static_cast<std::int16_t>(swapBytes(static_cast<std::uint16_t>(val)));
}

std::int32_t swapBytes (std::int32_t val)
{
    return static_cast<std::int32_t>(swapBytes(static_cast<std::uint32_t>(val)));
}

std::int64_t swapBytes (std::int64_t val)
{
    return static_cast<std::int64_t>(swapBytes(static_cast<std::uint64_t>(val)));
}
