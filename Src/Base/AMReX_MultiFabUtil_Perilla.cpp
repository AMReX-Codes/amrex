...
namespace amrex
{
  ...
  void average_down_push (RGIter& rgi, Amr& amr, MultiFab& S_fine, MultiFab& S_crse, MultiFab& crse_S_fine, RegionGraph* RG_fine, RegionGraph* RG_crse, 
     ...
     {
       average_down_push(rgi,amr,S_fine,S_crse,crse_S_fine,RG_fine,RG_crse,fgeom,cgeom,scomp,ncomp,rr*IntVect::TheUnitVector(),f,tid);
     }
  ...
  void average_down_pull (RGIter& rgi, MultiFab& S_fine, MultiFab& S_crse, RegionGraph* RG_fine, RegionGraph* RG_crse, const Geometry& fgeom, const Geometry& cgeom, 
		     int scomp, int ncomp, int rr, int f, int tid)
     {
       average_down_pull(rgi, S_fine,S_crse,RG_fine,RG_crse,fgeom,cgeom,scomp,ncomp,rr*IntVect::TheUnitVector(),f,tid);
     }
  ...
  void average_down_push (RGIter& rgi, Amr& amr, MultiFab& S_fine, MultiFab& S_crse, MultiFab& crse_S_fine, RegionGraph* RG_fine, RegionGraph* RG_crse, 
...
#if (BL_SPACEDIM == 3)
	amrex::average_down_push(rgi, amr, S_fine, S_crse, crse_S_fine, RG_fine, RG_crse, scomp, ncomp, ratio, f, tid);
	return;
#else
	...
	Perilla::multifabCopyPush( RG_crse, RG_fine, &S_crse, &crse_S_fine, f, tid, scomp, 0, ncomp, 0, 0, false);
  ...
  void average_down_pull (RGIter& rgi, MultiFab& S_fine, MultiFab& S_crse, RegionGraph* RG_fine, RegionGraph* RG_crse, const Geometry& fgeom, const Geometry& cgeom, 
...
#if (BL_SPACEDIM == 3)
	amrex::average_down_pull(rgi, S_fine, S_crse, RG_fine, RG_crse, scomp, ncomp, ratio, f, tid);
	return;
#else
	...
	Perilla::multifabCopyPull(rgi, RG_crse, RG_fine, &S_crse, &S_fine, f, tid, scomp, 0, ncomp, 0, 0, false);
  ...
  void average_down_push (RGIter& rgi, Amr& amr, MultiFab& S_fine, MultiFab& S_crse, MultiFab& crse_S_fine, RegionGraph* RG_fine, RegionGraph* RG_crse,
			  int scomp, int ncomp, int rr, int f, int tid)
    {
      average_down_push(rgi,amr,S_fine,S_crse,crse_S_fine,RG_fine,RG_crse,scomp,ncomp,rr*IntVect::TheUnitVector(),f,tid);
    }
  void average_down_pull (RGIter& rgi, MultiFab& S_fine, MultiFab& S_crse, RegionGraph* RG_fine, RegionGraph* RG_crse, int scomp, int ncomp, int rr, int f, int tid)
    {
      average_down_pull(rgi, S_fine,S_crse,RG_fine,RG_crse,scomp,ncomp,rr*IntVect::TheUnitVector(),f,tid);
    }
