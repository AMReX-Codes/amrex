...
{
    return maxSize(IntVect(BL_D_DECL(block_size,block_size,block_size)));
}
...
{
    return refine(IntVect(BL_D_DECL(refinement_ratio,refinement_ratio,refinement_ratio)));
}
...
{
    return coarsen(IntVect(BL_D_DECL(refinement_ratio,refinement_ratio,refinement_ratio)));
}
