...
contains
  ...
  subroutine multifab_fill_ghost_cells_new(fine,crse,fine_domain,ng,ir,bc_crse,bc_fine,icomp,bcomp,nc)
...
!  subroutine multifab_fill_ghost_cells_old(fine,crse,fine_domain,ng,ir,bc_crse,bc_fine,icomp,bcomp,nc)
  ...
  subroutine multifab_fill_ghost_cells_oold(fine,crse,fine_domain,ng,ir,bc_crse,bc_fine,icomp,bcomp,nc)
!  subroutine multifab_fill_ghost_cells(fine,crse,fine_domain,ng,ir,bc_crse,bc_fine,icomp,bcomp,nc)
