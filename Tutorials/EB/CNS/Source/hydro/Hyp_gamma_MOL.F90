...
! ::: ----------------------------------------------------------------
  ...
  subroutine hyp_mol_gam_3d(q, qd_lo, qd_hi, &
    ...
    qtlo(1) = lo(1) - nextra - 1 
    qtlo(2) = lo(2) - nextra - 1 
    qtlo(3) = lo(3) - nextra - 1 
    qthi(1) = hi(1) + nextra + 1 
    qthi(2) = hi(2) + nextra + 1 
    qthi(3) = hi(3) + nextra + 1 
