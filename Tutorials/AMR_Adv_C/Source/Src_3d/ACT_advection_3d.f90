...
! ::: 
      ...
      use meth_params_module, only : NVAR, URHO, UX, UY, UZ, UFA, &
                                     QVAR, QRHO, QU, QV, QW, QFA, &
                                     nadv
...
! ::: 
      ...
      use meth_params_module, only : NVAR, URHO, UX, UZ, UFA, nadv
...
! ::: 
      ...
      use meth_params_module, only : QVAR, NVAR, QRHO, QFA, &
                                     URHO, UFA, nadv
