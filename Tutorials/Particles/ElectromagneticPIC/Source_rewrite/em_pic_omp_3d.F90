subroutine push_momentum_boris_omp(np, uxp, uyp, uzp, gaminv, &
     ex, ey, ez, bx, by, bz, q, m, dt) bind(c,name='push_momentum_boris_omp')
...
subroutine push_position_boris_omp(np, structs, uxp, uyp, uzp, gaminv, dt) &
    bind(c,name='push_position_boris_omp')
...
subroutine deposit_current_omp(jx, jxlo, jxhi, jy, jylo, jyhi, jz, jzlo, jzhi, np, structs, &
     uxp, uyp, uzp, gaminv, w, q, plo, dt, dx) bind(c,name='deposit_current_omp')
...
subroutine gather_magnetic_field_omp(np, structs, bx, by, bz, &
     ...
     bind(c,name='gather_magnetic_field_omp')
...
subroutine gather_electric_field_omp(np, structs, ex, ey, ez, &
     exg, exglo, exghi, eyg, eyglo, eyghi, ezg, ezglo, ezghi, plo, dx) &
     bind(c,name='gather_electric_field_omp')
...
subroutine push_electric_field_x_omp(xlo, xhi, ex, exlo, exhi,               &
     by, bylo, byhi, bz, bzlo, bzhi, jx, jxlo, jxhi, mudt, dtsdy, dtsdz) &
     bind(c,name='push_electric_field_x_omp')
...
subroutine push_electric_field_y_omp(ylo, yhi, &
     ey, eylo, eyhi, bx, bxlo, bxhi, bz, bzlo, bzhi, &
     jy, jylo, jyhi, mudt, dtsdx, dtsdz) &
     bind(c,name='push_electric_field_y_omp')
...
subroutine push_electric_field_z_omp(zlo, zhi, &
     ez,ezlo, ezhi, bx, bxlo, bxhi, by, bylo, byhi, &
     jz, jzlo, jzhi, mudt, dtsdx, dtsdy) &
     bind(c,name='push_electric_field_z_omp')
...
subroutine push_magnetic_field_x_omp(xlo, xhi, bx, bxlo, bxhi, ey, eylo, eyhi, &
     ez, ezlo, ezhi, dtsdy, dtsdz) &
     bind(c,name='push_magnetic_field_x_omp')
...
subroutine push_magnetic_field_y_omp(ylo, yhi, by, bylo, byhi, ex, exlo, exhi, &
     ez, ezlo, ezhi, dtsdx, dtsdz) &
     bind(c,name='push_magnetic_field_y_omp')
...
subroutine push_magnetic_field_z_omp(zlo, zhi, bz, bzlo, bzhi, ex, exlo, exhi, &
     ey, eylo, eyhi, dtsdx, dtsdy) &
     bind(c,name='push_magnetic_field_z_omp')
