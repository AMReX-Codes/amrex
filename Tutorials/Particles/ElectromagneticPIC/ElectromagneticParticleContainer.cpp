...
{   
    ...
    for (ElectromagneticParIter pti(*this, lev); pti.isValid(); ++pti)
    {
        ...
        gather_magnetic_field(np, particles.data(),
        ...
        gather_electric_field(np, particles.data(),
        ...
        push_momentum_boris(np, uxp.data(), uyp.data(), uzp.data(), ginv.data(),
                            Exp.data(), Eyp.data(), Ezp.data(),
                            Bxp.data(), Byp.data(), Bzp.data(),
                            m_charge, m_mass, dt);
...
EnforcePeriodicBCs()
{
    ...
    for (ElectromagneticParIter pti(*this, lev); pti.isValid(); ++pti)
    {
        ...
        enforce_periodic(np, particles.data(), plo, phi);
    }
}
