...
#include <WMLES.H>
#include <WMLES_derive.H>

using namespace amrex;

int WMLES::num_state_data_types = 0;
Parm* WMLES::h_parm = nullptr;
Parm* WMLES::d_parm = nullptr;
ProbParm* WMLES::h_prob_parm = nullptr;
ProbParm* WMLES::d_prob_parm = nullptr;
...
WMLES::variableSetUp ()
{
    h_parm = new Parm{}; // This is deleted in WMLES::variableCleanUp().
    ...
    StateDescriptor::BndryFunc bndryfunc(wmles_bcfill);
