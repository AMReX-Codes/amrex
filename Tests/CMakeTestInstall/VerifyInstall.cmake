...
set(_configure_cmd
    "${CMAKE_COMMAND}"
    "-G" "${AMREX_TEST_INSTALL_GENERATOR}"
    "-S" "${AMREX_TEST_INSTALL_TEST_PROJECT_DIR}"
    "-B" "${AMREX_TEST_INSTALL_TEST_BUILD_DIR}"
    "-DAMReX_ROOT=${AMREX_TEST_INSTALL_PREFIX}"
    "-DCMAKE_C_COMPILER=${AMREX_TEST_INSTALL_C_COMPILER}"
    "-DCMAKE_CXX_COMPILER=${AMREX_TEST_INSTALL_CXX_COMPILER}")
if(AMREX_TEST_INSTALL_GENERATOR_PLATFORM)
    list(APPEND _configure_cmd
        "-A" "${AMREX_TEST_INSTALL_GENERATOR_PLATFORM}")
endif()
if(AMREX_TEST_INSTALL_GENERATOR_TOOLSET)
    list(APPEND _configure_cmd
        "-T" "${AMREX_TEST_INSTALL_GENERATOR_TOOLSET}")
endif()
