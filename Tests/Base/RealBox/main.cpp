...
void test_contains_closed_interval ()
{
    ...
    XDim3 lo_dim3{AMREX_D_DECL(.x = lo_arr[0], .y = lo_arr[1], .z = lo_arr[2])};
    XDim3 hi_dim3{AMREX_D_DECL(.x = hi_arr[0], .y = hi_arr[1], .z = hi_arr[2])};
    XDim3 lo_dim3_outside{
        AMREX_D_DECL(.x = lo_arr[0] - delta, .y = lo_arr[1], .z = lo_arr[2])};
    XDim3 hi_dim3_outside{
        AMREX_D_DECL(.x = hi_arr[0] + delta, .y = hi_arr[1], .z = hi_arr[2])};
