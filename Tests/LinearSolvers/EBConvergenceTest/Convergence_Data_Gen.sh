...
./main3d.gnu.TEST.MPI.ex inputs n_cell=512 max_grid_size=512
mv phi-0_H phi-0_512_H
MultiFabToMatLab3d.gnu.MPI.ex infile=phi-0_512

./main3d.gnu.TEST.MPI.ex inputs n_cell=1024 max_grid_size=1024
mv phi-0_H phi-0_1024_H
MultiFabToMatLab3d.gnu.MPI.ex infile=phi-0_1024
