...
% Lawrence Berkeley National Laboratory 
    ...
    y16 = x16; 
    z16 = x16; 
    [X16, Y16, Z16] = meshgrid(x16, y16, z16); 
    ...
    y32 = x32; 
    z32 = x32; 
    [X32, Y32, Z32] = meshgrid(x32, y32 ,z32); 
    ...
    y64 = x64; 
    z64 = x64;
    [X64, Y64, Z64] = meshgrid(x64, y64, z64); 
    ...
    y128 = x128; 
    z128 = x128;
    [X128, Y128, Z128] = meshgrid(x128, y128, z128); 
    ...
    y256 = x256;
    z256 = x256; 
    [X256, Y256, Z256] = meshgrid(x256, y256, z256); 
