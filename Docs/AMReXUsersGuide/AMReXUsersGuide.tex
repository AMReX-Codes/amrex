...
\lstdefinelanguage{cpp}{
  language     = C++,
  morekeywords = [2]{amrex,IntVect,Array,IndexType,Box,BaseFab,FArrayBox,IArrayBox,BoxArray,DistributionMapping,ParallelDescriptor,FabArray,MultiFab,MFIter,AMREX_SPACEDIM,AMREX_D_DECL},
