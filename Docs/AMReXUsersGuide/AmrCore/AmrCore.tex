...
\begin{figure}
  \centering
  \includegraphics[width=1in]{./AmrCore/figs/Adv1}
  \includegraphics[width=1in]{./AmrCore/figs/Adv2}
  \includegraphics[width=1in]{./AmrCore/figs/Adv3}
  \includegraphics[width=1in]{./AmrCore/figs/Adv4}
  \includegraphics[width=1in]{./AmrCore/figs/Adv5}
...
\end{equation}
The velocity field is a specified function of space and time.  The initial scalar field is a
...
the only level.  If $\ell>0$, obtain boundary data using time-interpolated data from 
the grids at $\ell-1$ where appropriate.
\item If $\ell<\ell_{\rm max}$
\begin{itemize}
\item Advance level $(\ell+1)$ for $r$ time steps, 
$\Delta t^{\ell+1} = \frac{1}{r}\Delta t^{\ell}$, using level-$\ell$ data and the 
physical boundary conditions.
\item Synchronize the data between levels $\ell$ and $\ell+1$, and interpolate corrections
to finer levels $[\ell+2,\cdots,\ell_{\rm max}]$.
\end{itemize}
\end{itemize}
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=4in]{./AmrCore/figs/subcycling}
