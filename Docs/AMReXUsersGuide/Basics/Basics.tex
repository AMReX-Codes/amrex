...
class is {\tt MultiFab} derived from {\tt FabArray<FArrayBox>}.  {\tt
  MultiFab} has a number of constructors.  For example,
\begin{lstlisting}[language=cpp]
  // ba is BoxArray
...
used for constructing {\tt FArrayBox} will be {\tt Box\{(8,8,8)
