...
difference between {\tt Array} and {\tt std::vector} is that {\tt
  ...
  DEBUG=TRUE}.  To use this class, include {\tt AMReX\_Array.H}.
...
has provided {\tt namespace ParallelDesriptor}.  To use it, include
{\tt <AMReX\_ParallelDesriptor.H>}.  The frequently used
functions are 
