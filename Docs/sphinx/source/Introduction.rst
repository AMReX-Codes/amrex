...
Because AMReX's core is mainly written in C++, the basics of AMReX are first introduced in C++, with a description of their Fortran wrappers following later, if available.

Besides the User's Guide, there is documentation generated by Doxygen at https://amrex-codes.github.io/amrex/doxygen. Documentation on migration from BoxLib is available at Docs/Migration.
