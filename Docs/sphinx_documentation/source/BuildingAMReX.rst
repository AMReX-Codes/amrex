...
AMReX mostly uses standard C++11,  and there are only a few places that are UNIX/Linux specific.
...
(3) Memory profiling.  This is an optional feature in AMReX that is not enabled by default.  It reads memory system information from the OS to give us a summary of our memory usage.
