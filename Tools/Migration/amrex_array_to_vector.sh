...
find . -type d \( -name .git -o -path ./Tools/Migration -o -path ./Docs/Migration \) -prune -o -type f \( -name "*.H" -o -name "*.h" -o -name "*.cpp" -o -name "*.c" -o -name "*.cc" -o -name "*.tex" \) -exec grep -Iq . {} \; -exec sed -i 's/amrex::Array</amrex::Vector</g' {} +
