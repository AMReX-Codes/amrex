...
#
# PREPROCESS_BOXLIB_FORTRAN90( OUTVAR source1 ... sourceN )
#
...
#
# Example:
#  preprocess_boxlib_fortran90( SRCS src/test1.F src/test2.F )
#  add_executable( test ${SRCS} )

if(__PREPROCESS_BOXLIB_FORTRAN90_INCLUDED)
  return()
endif()
set(__PREPROCESS_BOXLIB_FORTRAN90_INCLUDED)

find_package(Perl REQUIRED)

function(preprocess_boxlib_fortran90 OUTVAR)
  ...
  foreach( f ${ARGN} )
    ...
    if(MSVC)
      set(of "${CMAKE_CURRENT_BINARY_DIR}\${p}${n}${e}.f90")
      add_custom_command(
        OUTPUT ${of}
        COMMAND fpp /m /ansi ${inclflags} ${defflags} ${f} > ${of}
        DEPENDS ${f}
      ...
      add_custom_command(
        OUTPUT ${of}
        COMMAND ${CMAKE_C_COMPILER} -E ${PREPROCESS_FLAGS} ${inclflags} ${defflags} ${f} > ${of}
        DEPENDS ${f}
        COMMENT "Preprocessing ${f}..."
      )
    endif(MSVC)
...
endfunction(preprocess_boxlib_fortran90)
