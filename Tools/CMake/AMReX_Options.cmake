...
cmake_dependent_option( ENABLE_TIMEMORY "Enable Timemory" OFF
    "NOT ENABLE_BASE_PROFILE" OFF)
print_option( ENABLE_TIMEMORY )

set(_ENABLE_TIMEMORY_COMPONENTS "${ENABLE_TIMEMORY_COMPONENTS}")
if(NOT _ENABLE_TIMEMORY_COMPONENTS)
    set(_ENABLE_TIMEMORY_COMPONENTS OFF)
endif()
cmake_dependent_option( ENABLE_TIMEMORY_COMPONENTS "Build a custom version of timemory"
    ${_ENABLE_TIMEMORY_COMPONENTS}
    "ENABLE_TIMEMORY" OFF)
print_option( ENABLE_TIMEMORY_COMPONENTS )

set(TP_PROFILE_VALUES IGNORE CRAYPAT FORGE VTUNE TIMEMORY)
set(TP_PROFILE IGNORE CACHE STRING "Third-party profiling options: <CRAYPAT,FORGE,VTUNE,TIMEMORY>")
