#
# This file is a slighlty modified version (to avoid conflicts) of select_compute_arch.cmake from CMake 3.13.2.
# select_compute_arch.cmake works with native CUDA support starting with CMake 3.12+.
# For cmake < 3.12 we provide the same file with different functions name.
# NB: all of this implies that select_compute_arch.cmake from CMake < 3.12 does not work with native CUDA support
# 
...
#
function(get_installed_gpus OUT_VARIABLE)
...
function(get_nvcc_arch_flags out_variable)
  ...
  elseif("${CUDA_ARCH_LIST}" STREQUAL "Auto")
    get_installed_gpus(CUDA_ARCH_LIST)
