...
//
// $Id: DiffSameGrid.cpp,v 1.1 1999-02-24 23:31:21 sstanley Exp $
//
      ...
      char* argv[])
{
    ...
    assert(amrDataI.FinestLevel() == amrDataE.FinestLevel());
