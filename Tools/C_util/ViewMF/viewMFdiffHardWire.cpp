...
//
    ...
    if (lvl == 0)
    {
       if (dir == 0)
        {
            edge0Small = IntVect(D_DECL( 0,  0, 0));
            edge0Big   = IntVect(D_DECL( 0,120,48));
            edge1Small = IntVect(D_DECL(72,  0, 0));
            edge1Big   = IntVect(D_DECL(72,120,48));
        }
       else if (dir == 2)
        {
            edge0Small = IntVect(D_DECL( 0,  0, 0));
            edge0Big   = IntVect(D_DECL(72,120, 0));
            edge1Small = IntVect(D_DECL( 0,  0,48));
            edge1Big   = IntVect(D_DECL(72,120,48));
        }
    }
    else if (lvl == 1)
    {
       if (dir == 0)
       ...
       else if (dir == 2)
        {
            ...
            edge0Big   = IntVect(D_DECL(32,248,  0));
            edge1Small = IntVect(D_DECL( 4,232,192));
            edge1Big   = IntVect(D_DECL(32,248,192));
        }
    }
