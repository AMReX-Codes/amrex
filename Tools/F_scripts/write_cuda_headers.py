        ...
        while line:
            ...
            if line.startswith("#pragma gpu"):
                ...
                hout.write("#if ((__CUDACC_VER_MAJOR__ > 9) || (__CUDACC_VER_MAJOR__ == 9 && __CUDACC_VER_MINOR__ >= 1))\n" \
                           "    AMREX_GPU_CHECK(cudaFuncSetAttribute(&cuda_{}, cudaFuncAttributePreferredSharedMemoryCarveout, 0));\n" \
                           "#endif\n".format(func_name))
                ...
                hout.write("    AMREX_GPU_CHECK(cudaGetLastError());\n")

                if 'AMREX_DEBUG' in defines:
                    hout.write("AMREX_GPU_CHECK(cudaDeviceSynchronize());\n")
