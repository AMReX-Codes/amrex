...
# Check the J fields
assert np.allclose( data['jz'].to_ndarray(), 0, atol=1.e-2 )
assert np.allclose( data['jy'].to_ndarray(), 0, atol=1.e-2 )
...
assert np.allclose( data['Ey'].to_ndarray(), 0, atol=5.e-5 )
